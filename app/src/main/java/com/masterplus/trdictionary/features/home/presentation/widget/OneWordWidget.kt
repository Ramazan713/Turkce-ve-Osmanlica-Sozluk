...
private val wordInfo = ShortInfoEnum.Word


class OneWordWidget: GlanceAppWidget() {

    companion object{
        val wordDataKey = stringPreferencesKey("simpleOneWord")
    }
    ...
    override suspend fun provideGlance(context: Context, id: GlanceId) {
        provideContent {
            ...
            ShortInfoGroupWidgetItem(
                ...
                title = context.getString(R.string.one_word_c),
                infoModel = infoModel,
...
@AndroidEntryPoint
class OneWordWidgetReceiver : GlanceAppWidgetReceiver(){
    override val glanceAppWidget: GlanceAppWidget get() = OneWordWidget()
